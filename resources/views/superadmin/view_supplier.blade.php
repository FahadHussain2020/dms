        ...
        <tbody>
          <tr>
            ...
            <td>
             ...
             <a href='{{url("/superadmin/deletesupplier/$supplier->id")}}' data-toggle="tooltip"  title="Delete"class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> </a>
           </td>
           @endif
           @endforeach
           @endif
        ...
        <div class="container-fluid">
         <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form method="POST" autocomplete="off" action='{{url("/superadmin/createsupplier")}}'>
              {{csrf_field()}}
        ...
        <div class="container-fluid">
         <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form method="POST" autocomplete="off" action="{{url('/superadmin/editsupplier')}}">
              {{csrf_field()}}
              <div class="form-group">
