            ...
            <tbody>
              ...
              <tr>
               ...
               <td>   
                ...
                <a href='{{url("/superadmin/deletesalesman/$sale->id")}}'data-toggle="tooltip"  title="Delete" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> </a>
              </td>
            </tr> 
            @endforeach
            @endif
        ...
        <div class="container-fluid">
         <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form method="POST" autocomplete="off" action="{{url('/superadmin/editsalesman')}}">
              {{csrf_field()}}
              <div class="form-group">
