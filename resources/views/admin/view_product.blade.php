						...
						<tbody>
							<tr>
								...
								<td>
									...
									<a href='{{url("/admin/deleteproduct/$product->id")}}' data-toggle="tooltip"  title="Delete"class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> </a>
								</td>
								@endif
								@endforeach
								@endif
			...
			<div class="modal-body">
				<div class="container-fluid">
					<div class="card mb-3">
						...
						Create Product</div>
						<div class="card-body">
							<form method="POST" autocomplete="off" enctype="multipart/form-data" action='{{url("/admin/createproduct")}}'>
								{{csrf_field()}}
				...
				<div class="container-fluid">
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							enctype="multipart/form-data" action='{{url("/admin/updateproduct")}}'>
								{{csrf_field()}}
