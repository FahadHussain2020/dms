        ...
        <tbody>
          ...
          <tr>
           ...
           <td>
             ...
             <a href='{{url("/superadmin/deleteretailer/$retailer->id")}}' data-toggle="tooltip"  title="Delete"class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> </a>
           </td>
           @endforeach
           @endif
         </tr> 
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="card mb-3">
            ...
            Create Retailer</div>
            <div class="card-body">
              <form method="POST" autocomplete="off" action='{{url("/superadmin/createretailer")}}'>
                {{csrf_field()}}
      ...
      <div class="modal-body">
        <div class="container-fluid">
          <div class="card mb-3">
            ...
            Update Retailer</div>
            <div class="card-body">
              <form method="POST" autocomplete="off" action='{{url("/superadmin/updateretailer")}}'>
                {{csrf_field()}}
                <div class="form-group">
